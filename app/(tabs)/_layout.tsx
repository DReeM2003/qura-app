...
import NotificationTab from "../components/notifications";
...
function BubbleIcon({ focused, src, tint, iconSize = 24, bubbleSize = 44 }: BubbleIconProps) {
...
export default function Layout() {
  ...
  >
      ...
      <NotificationTab open={notificationOpen} onClose={() => setNotificationOpen(false)} />
  </>        
  );
}
